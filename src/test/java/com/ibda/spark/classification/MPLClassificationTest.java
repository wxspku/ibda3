 ...
 * 神经网络
 */
public class MPLClassificationTest extends SparkClassificationTest<MultilayerPerceptronClassifier, MultilayerPerceptronClassificationModel> {
    @Override
    public void initTrainingParams() {
        ...
        int[] layers = new int[]{5, 10, 20, 40, 20, 10, 5, 2};
    ...
    public void test02MachineLearning() throws IOException {
        trainingParams.put("layers", new int[]{4, 10, 20, 40, 20, 10, 5, 3}); //default 50
